...
const ECommerceIcon = () => (
  <svg className="w-16 h-16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M4 4H5.62L6.72 16.43C6.78 17.02 6.98 17.58 7.33 18.05C7.68 18.52 8.16 18.87 8.71 19.07C9.27 19.27 9.87 19.31 10.45 19.19C11.03 19.07 11.56 18.79 12 18.39L17.55 13.79C18.11 13.32 18.75 12.94 19.45 12.65C20.14 12.36 20.88 12.17 21.63 12.09L22 12.04" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
    <path d="M8 20C9.1 20 10 19.1 10 18C10 16.9 9.1 16 8 16C6.9 16 6 16.9 6 18C6 19.1 6.9 20 8 20Z" fill="currentColor"/>
    <path d="M19 20C20.1 20 21 19.1 21 18C21 16.9 20.1 16 19 16C17.9 16 17 16.9 17 18C17 19.1 17.9 20 19 20Z" fill="currentColor"/>
  </svg>
);
...
const AdvertisingIcon = () => (
  <svg className="w-16 h-16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M7 9L12 12L17 9" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
...
const AIIcon = () => (
  <svg className="w-16 h-16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M15 9C15 7.34315 13.6569 6 12 6C10.3431 6 9 7.34315 9 9C9 10.6569 10.3431 12 12 12" stroke="currentColor" strokeWidth="2"/>
  </svg>
); 