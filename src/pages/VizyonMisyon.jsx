    ...
    <div className="min-h-screen text-white w-full overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-12">
          ...
          >
            <div className="absolute top-0 right-0 w-24 md:w-32 h-24 md:h-32 bg-emerald-500 opacity-10 rounded-full -mr-12 -mt-12 group-hover:scale-150 transition-transform duration-500"></div>
            <div className="flex items-center justify-center mb-4 md:mb-6 text-emerald-400">
              <img src={VisionSvg} alt="Vision" className="h-16 w-16 md:h-20 md:w-20" />
            </div>
          ...
          >
            <div className="absolute top-0 right-0 w-24 md:w-32 h-24 md:h-32 bg-emerald-500 opacity-10 rounded-full -mr-12 -mt-12 group-hover:scale-150 transition-transform duration-500"></div>
            <div className="flex items-center justify-center mb-4 md:mb-6 text-emerald-400">
              <img src={MissionSvg} alt="Mission" className="h-16 w-16 md:h-20 md:w-20" />
            </div>
            <h2 className="text-2xl md:text-3xl font-bold mb-4 md:mb-6 text-center">
          ...
          <div className="max-w-4xl mx-auto px-2">
            {t('aboutPage.visionMission.goals.items', { returnObjects: true }).map((goal, index) => (
              <motion.div
                ...
                className="flex flex-col sm:flex-row items-start sm:items-center mb-6 md:mb-8 group"
              >
                <div className="flex-shrink-0 w-12 h-12 md:w-16 md:h-16 bg-white/5 backdrop-blur-sm rounded-full flex items-center justify-center border-2 border-emerald-500 mb-4 sm:mb-0 sm:mr-6 group-hover:bg-emerald-500 group-hover:text-black transition-all duration-300">
                  <span className="text-xl md:text-2xl font-bold">{index + 1}</span>
                </div>
                <div className="bg-white/5 backdrop-blur-sm p-4 md:p-6 rounded-lg w-full hover:bg-white/10 transition-colors">
