...
const pazaryeriFeatures = [
  {
    ...
    description: "Milyonlarca aktif kullanıcıya sahip pazaryerlerinde ürünlerinizi sergileyerek satışlarınızı artırın."
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description: "Rakiplerinizin stratejilerini analiz ederek pazarda öne çıkmanızı sağlıyoruz."
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div className="min-h-screen w-full py-20">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold text-white text-center mb-6">
          Sanal Pazaryeri <br />
          <ColourfulText text="Danışmanlığı" className="mt-2" colorTheme="purple" />
        </h1>
        <p className="text-neutral-400 text-lg md:text-xl text-center max-w-3xl mx-auto mb-12">
          Hepsiburada, Trendyol, N11 gibi popüler sanal pazaryerlerinde başarılı olmanız için danışmanlık hizmeti veriyoruz.
        </p>
      ...
      {/* Pazaryerleri */}
      <div className="container mx-auto px-4 mb-20">
        <h2 className="text-3xl font-bold text-white text-center mb-10">Çalıştığımız Pazaryerleri</h2>
        <div className="flex flex-wrap justify-center gap-8">
          <div className="bg-black/30 p-4 rounded-lg w-40 h-40 flex items-center justify-center">
            <p className="text-white font-semibold text-xl">Trendyol</p>
          </div>
          <div className="bg-black/30 p-4 rounded-lg w-40 h-40 flex items-center justify-center">
            <p className="text-white font-semibold text-xl">Hepsiburada</p>
          </div>
          <div className="bg-black/30 p-4 rounded-lg w-40 h-40 flex items-center justify-center">
            <p className="text-white font-semibold text-xl">N11</p>
          </div>
          <div className="bg-black/30 p-4 rounded-lg w-40 h-40 flex items-center justify-center">
            <p className="text-white font-semibold text-xl">Amazon</p>
          </div>
          <div className="bg-black/30 p-4 rounded-lg w-40 h-40 flex items-center justify-center">
            <p className="text-white font-semibold text-xl">GittiGidiyor</p>
          </div>
        </div>
      </div>
    </div>
